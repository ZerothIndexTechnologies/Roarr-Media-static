 ...
 */
var _hsq = _hsq || [];
_hsq.push(['setPortalId', 439788]);
_hsq.push(['trackPageView']);
_hsq.push(['setLegacy', false]);
_hsq.push(['addHashedCookieDomain', '233546881']);
_hsq.push(['addHashedCookieDomain', '20629287']);
_hsq.push(['addHashedCookieDomain', '59322610']);
_hsq.push(['addHashedCookieDomain', '224894981']);
_hsq.push(['addHashedCookieDomain', '251652889']);
_hsq.push(['enableAutomaticLinker', true]);
_hsq.push(['embedHubSpotScript', 'https://js-na1.hs-scripts.com/439788.js', 'hs-script-loader']);
...
(function() {
        ...
        hstc.utils.resolveInitialUrl = function(t) {
            var e = window.location.origin
                , i = "__hsInitialUrl"
                , n = window[i] && "string" == typeof window[i] && URL.canParse(window[i], e) ? new URL(window[i],e) : null
        ...
        ;
        !function(t) {
            var e, i, n, r, s, o, c, a, h, u, l, p, g, f, d, k, m, y = "sizzle" + -new Date, v = t.document, C = 0, T = 0, _ = rt(), w = rt(), x = rt(), S = !1, b = function(t, e) {
                if (t === e) {
                    S = !0;
                    return 0
                }
                ...
                , U = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", q = H.replace("w", "w#"), j = "\\[" + M + "*(" + H + ")" + M + "*(?:([*^$|!~]?=)" + M + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + q + ")|)|)" + M + "*\\]", F = ":(" + H + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + j.replace(3, 8) + ")*)|.*)\\)|)", B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), V = new RegExp("^" + M + "*," + M + "*"), K = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), $ = new RegExp(M + "*[+~]"), W = new RegExp("=" + M + "*([^\\]'\"]*)" + M + "*\\]","g"), G = new RegExp(F), z = new RegExp("^" + q + "$"), Y = {
                ID: new RegExp("^#(" + H + ")"),
                CLASS: new RegExp("^\\.(" + H + ")"),
                ...
                filter: {
                    ...
                    CHILD: function(t, e, i, n, r) {
                        ...
                        return 1 === n && 0 === r ? function(t) {
                            ...
                            : function(e, i, a) {
                                var h, u, l, p, g, f, d = s !== o ? "nextSibling" : "previousSibling", k = e.parentNode, m = c && e.nodeName.toLowerCase(), v = !a && !c;
                                if (k) {
                                    if (s) {
                                        for (; d; ) {
                                            l = e;
            ...
            function yt(t, e, i, n, r, s) {
                ...
                return st((function(s, o, c, a) {
                        var h, u, l, p = [], g = [], f = o.length, d = s || Tt(e || "*", c.nodeType ? [c] : c, []), k = !t || !s && e ? d : mt(d, p, t, c, a), m = i ? r || (s ? t : f || n) ? [] : o : k;
                        i && i(k, m, c, a);
                        if (n) {
                            h = mt(m, g);
                            n(h, [], c, a);
            ...
            function Ct(t, e) {
                var i = 0
                    ...
                    var f, d, k, m = [], y = 0, v = "0", T = c && [], _ = null != g, w = a, x = c || o && r.find.TAG("*", g && h.parentNode || h), S = C += null == w ? 1 : Math.random() || .1, b = x.length;
                    if (_) {
                        a = h !== l && h;
                        n = i
                    }
