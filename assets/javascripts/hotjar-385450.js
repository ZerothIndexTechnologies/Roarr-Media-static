window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["ask.popover_redesign", "client_script.compression.pc", "error_reporting", "feedback.embeddable_widget", "survey.image_question", "survey.screenshots", "settings.billing_v2", "tcvs_v2", "feedback.widget_telemetry", "survey.embeddable_widget", "survey.type_button", "csq_theme", "feedback.widgetV2"],
    "tracking_code_verified": true,
    "cs_project_id": null,
    "account_id": 53196,
    "account_signature": "fcf390b5ae86bbd60eac4f8aa4a79dbec60648453350970f2fae39ec721396ba"
};
...
!function() {
    ...
    var o, s = function() {
        ...
        var n;
        c.loggedMetrics[e] = a(a({}, c.loggedMetrics[e]), {}, ((n = {})[t] = r || {},
            n))
    }, d = function(e) {
        if (!e)
            return "value";
        ...
        return "lab" === e && (r = u.browser.inLab),
        "field" === e && (r = c.isFieldMetricsEnabled),
            t ? r && t.flush : r
    }, h = function(e) {
        var t = !1
        ...
        count: function(e, t) {
            ...
            try {
                ...
                if (r ? (p = (h && h[l] || 0) + (r.value || 1),
                    c.loggedMetrics[e] = a(a({}, h), {}, ((u = {})[l] = null != r && r.flush ? 0 : p,
                        u))) : p = 1,
                    f(s, r)) {
                    var m = {
                        name: e,
    ...
    if (window.hjLazyModules = window.hjLazyModules || {
        ...
        window.hjBootstrap = window.hjBootstrap || function(e, t, r) {
            ...
            ,
            window.hjBootstrap("https://script.hotjar.com/", "modules.f5772d147096c4644991.js", "385450"),
...
!function() {
    try {
        ...
        n && (e._sentryDebugIds = e._sentryDebugIds || {},
            e._sentryDebugIds[n] = "8bb65d8e-01e0-5767-8dda-f6a5630621ac")
    } catch (e) {}
}();
